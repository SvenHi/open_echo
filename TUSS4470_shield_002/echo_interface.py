...
SAMPLE_TIME = 12.5e-6     # ESP32-S3 OVERSAMPLE_FACTOR=1 (80 kHz)
# SAMPLE_TIME = 25.0e-6     # ESP32-S3 OVERSAMPLE_FACTOR=2 (40 kHz)
# SAMPLE_TIME = 50.0e-6     # ESP32-S3 OVERSAMPLE_FACTOR=4 (20 kHz)
# SAMPLE_TIME = 11.0e-6     # RP2040 max sample speed with 10 microseconds additional delay per sample
# SAMPLE_TIME = 10.0e-6     # RP2040 realistic average sampling rate
# SAMPLE_TIME = 7.682e-6  # 7.682 microseconds on STM32F103 max sample speed
# SAMPLE_TIME = 1.290e-6     # RP2040 max sample speed without additional delay
